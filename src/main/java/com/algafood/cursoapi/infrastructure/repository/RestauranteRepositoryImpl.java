...
import static com.algafood.cursoapi.infrastructure.repository.spec.RestauranteSpecs.comFreteGratis;
import static com.algafood.cursoapi.infrastructure.repository.spec.RestauranteSpecs.comNomeSemelhante;
...
import com.algafood.cursoapi.domain.repository.RestauranteRepositoryQuerys;
...
public class RestauranteRepositoryImpl implements RestauranteRepositoryQuerys {
	...
	public List<Restaurante> find(String nome, BigDecimal taxaFreteInicial, BigDecimal taxaFreteFinal) {
		...
		critera.where(predicates.toArray(new Predicate[0]));
